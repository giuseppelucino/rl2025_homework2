    ...
    const Eigen::VectorXd &q_max)
{
    ...
    // Matrice di trasformazione delle velocit\u00e0 T_v
    ...
    // Velocit\u00e0 Primaria: $\mathbf{\dot{q}}_{prim} = A^{\dagger} \cdot (-K_p \mathbf{e}_{vis})$
    ...
    // ----------------------------------------------------------------------
    // 2. Task Secondario 1 (Priorit\u00e0 Alta): Controllo del Rollio
    // ----------------------------------------------------------------------
    ...
    // ----------------------------------------------------------------------
    // 3. Task Secondario 2 (Priorit\u00e0 Bassa): Joint Limit Avoidance (JLA)
    // ----------------------------------------------------------------------
    ...
    // ----------------------------------------------------------------------
    // 4. Risultato Finale: $\mathbf{\dot{q}} = \mathbf{\dot{q}}_{prim} + \mathbf{\dot{q}}_{roll} + \mathbf{\dot{q}}_{jla}$
    // ----------------------------------------------------------------------
    ...
    if (lap_finished && roll_finished) {
        ...
        // Arresto Rigido: Azzeramento completo della velocit\u00e0.
...
// ===== Generazione traiettoria lineare nello spazio cartesiano (NON MODIFICATO) =====
